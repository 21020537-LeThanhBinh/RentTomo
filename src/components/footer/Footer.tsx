      ...
      <div className="max-w-[2520px] mx-auto xl:px-20 md:px-10 sm:px-2 px-4 flex gap-8 py-8 flex-wrap md:gap-0">
        ...
        <div className="md:flex-1 flex flex-col gap-2">
          ...
          <ul className="flex items-center gap-6">
            ...
            <li>
              <Link href="https://www.linkedin.com/in/b%C3%ACnh-l%C3%AA-42b40a251/" aria-label="Linkedin" className="block">
            ...
            <li>
              <Link href="https://github.com/lethanksbinh/RentxFriend" aria-label="Twitter" className="block">
