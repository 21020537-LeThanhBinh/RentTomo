  ...
  return (
    <footer className="bg-neutral-800">
      <div className="max-w-[2520px] mx-auto xl:px-20 md:px-10 sm:px-2 px-4 flex flex-col items-center gap-8 pt-[2.0625rem] pb-[1.875rem] md:flex-row md:gap-0">
        ...
        <nav aria-label="Footer" className="flex-1 flex justify-end">
          <p className="text-white">Copyright Ⓒ 2023 RentTomo.</p>
        </nav>
      </div>
    </footer>
  );
