          ...
          tabsNames.map((tab, index) => (
            <li role="presentation" className="text-center" key={`b-${index}`}>
              <button
                ...
                className={`border-tab relative min-w-[15.2325rem] border-b-2 px-6 py-4 tracking-[0.04em] text-neutral-500 text-lg transition duration-300 hover:text-sky-600 md:px-[2.6875rem] md:py-[1.625rem] ${
